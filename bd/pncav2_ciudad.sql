...
CREATE TABLE `ciudad` (
  ...
  KEY `Id_Pais` (`Id_Pais`)
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=latin1 COMMENT='Tabla para almacenar las ciudades usadas dentro del sistema';
...
INSERT INTO `ciudad` VALUES (10,3,'LOS ANGELES'),(11,3,'NEW YORK'),(19,8,'CALI'),(20,8,'Bogotá'),(21,8,'Medellín');
