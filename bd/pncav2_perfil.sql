...
CREATE TABLE `perfil` (
  ...
  PRIMARY KEY (`per_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=latin1 COMMENT='Contiene los perfiles de acceso al sistema';
...
INSERT INTO `perfil` VALUES (1,'Administrador'),(2,'Consulta'),(3,'SOCIAL'),(4,'ANDIRED'),(5,'DOCUMENTAL'),(6,'Financiero');
