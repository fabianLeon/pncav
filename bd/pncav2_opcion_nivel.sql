...
DROP TABLE IF EXISTS `opcion_nivel`;
...
CREATE TABLE `opcion_nivel` (
  ...
  PRIMARY KEY (`opn_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1 COMMENT='Contiene los niveles de las opciones';
...
LOCK TABLES `opcion_nivel` WRITE;
/*!40000 ALTER TABLE `opcion_nivel` DISABLE KEYS */;
INSERT INTO `opcion_nivel` VALUES (0,'encabezado'),(1,'modulo'),(2,'opcion del modulo');
/*!40000 ALTER TABLE `opcion_nivel` ENABLE KEYS */;
UNLOCK TABLES;
