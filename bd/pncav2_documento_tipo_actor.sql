...
DROP TABLE IF EXISTS `documento_tipo_actor`;
...
CREATE TABLE `documento_tipo_actor` (
  ...
  PRIMARY KEY (`dta_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1 COMMENT='Contiene los tipos de actores';
...
LOCK TABLES `documento_tipo_actor` WRITE;
/*!40000 ALTER TABLE `documento_tipo_actor` DISABLE KEYS */;
INSERT INTO `documento_tipo_actor` VALUES (1,'Responsable');
/*!40000 ALTER TABLE `documento_tipo_actor` ENABLE KEYS */;
UNLOCK TABLES;
