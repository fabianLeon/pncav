...
DROP TABLE IF EXISTS `compromiso_estado`;
...
CREATE TABLE `compromiso_estado` (
  ...
  PRIMARY KEY (`ces_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1 COMMENT='Contiene los estados de los compromisos';
...
LOCK TABLES `compromiso_estado` WRITE;
/*!40000 ALTER TABLE `compromiso_estado` DISABLE KEYS */;
INSERT INTO `compromiso_estado` VALUES (1,'Abierto'),(2,'Cerrado'),(3,'Sin respuesta');
/*!40000 ALTER TABLE `compromiso_estado` ENABLE KEYS */;
UNLOCK TABLES;
