...
CREATE TABLE `instrumento` (
  ...
  PRIMARY KEY (`ins_id`),
  KEY `FK_TIPO` (`iti_id`),
  CONSTRAINT `FK_INSTRUMENTO_TIPO` FOREIGN KEY (`iti_id`) REFERENCES `instrumento_tipo` (`iti_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1 COMMENT='instrumentos de encuentas';
...
INSERT INTO `instrumento` VALUES (1,'individuo',1),(2,'organización',1);
